...
const translations: Record<Language, Translations> = {
  ...
  es: {
    ...
    'dashboard.total': 'Total',
    'dashboard.truncated': 'Salida truncada — el modelo de IA alcanzó su límite de tokens. Ejecuta el pipeline de nuevo con un valor num_predict más alto para un análisis completo.',
    'dashboard.socialIntel': 'Intel Social',
    'dashboard.infrastructure': 'Infraestructura',
    'dashboard.themes': 'Temas',
    'dashboard.tone': 'Tono',
    'dashboard.topPosts': 'Principales Publicaciones',
