...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    'about.text1':
      'Leemos los sistemas complejos desde la correlación disciplinaria — ingeniería, inteligencia, estrategia e investigación convergen en cada proyecto. No operamos desde teorías abstractas, sino desde experiencia real aplicada en cada campo.',
    'about.text2':
      'Nos asociamos con personas, no con contratos. Buscamos relaciones de consultoría donde ambas partes se beneficien, asesorando con rigor, dinamismo y enfoques pragmáticos. Cada proyecto es liderado directamente por un Arquitecto Principal con investigación propia y herramientas propietarias, reconociendo que los problemas más complejos no son solo técnicos: son humanos, sociales y sistémicos.',
    'about.feature1': 'Correlación disciplinaria aplicada — ingeniería, inteligencia, estrategia e investigación',
    'about.feature2': 'Relación directa con el fundador, sin gestores de cuentas',
    'about.feature3': 'Investigación propia y herramientas en producción activa',
  ...
  en: {
    ...
    'about.text1':
      'We read complex systems through disciplinary correlation — engineering, intelligence, strategy, and research converge on every engagement. We don\'t operate from abstract theory, but from real applied experience in each field.',
    'about.text2':
      'We partner with people, not contracts. We seek consulting relationships where both sides benefit, advising with rigor, dynamism, and pragmatic approaches. Every engagement is directly led by a Principal Architect with proprietary research and custom tooling — recognizing that the most complex problems are not just technical: they are human, social, and systemic.',
    'about.feature1': 'Applied cross-disciplinary expertise — engineering, intelligence, strategy & research',
    'about.feature2': 'Direct founder relationship, no account managers',
    'about.feature3': 'Proprietary research and tooling in active production',
    'about.panel.digital': 'Digital',
